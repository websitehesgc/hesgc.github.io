  ...
  <body>
      <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <h1 class="mb-3">Pre-School & Pre-Primary</h1>
                    <p>School classes are the catalysts of inspiration, nurturing the aspirations of the young minds who will one day shape the world. They are the crucibles of potential, where the fire of learning refines raw talent into polished skill. With every lesson, every discussion, and every interaction, school classes lay the foundation for a brighter future, one educated mind at a time.</p>
                    
                    <h1 class="mb-3">Class &#8544; - V&#8544;&#8544;&#8544; With Sr. Sec. Branches</h1>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="classes-item">
                            ...
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                                <a class="d-block text-center h3 mt-3 mb-4" href="">Art & Craft</a>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="classes-item">
                            ...
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                                <a class="d-block text-center h3 mt-3 mb-4" href="">Puzzle Solving</a>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="classes-item">
                            ...
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                                <a class="d-block text-center h3 mt-3 mb-4" href="">Play & Dance</a>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="classes-item">
                            ...
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                                <a class="d-block text-center h3 mt-3 mb-4" href="">Conversational Skill & Story Narration</a>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="classes-item">
                            ...
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                                <a class="d-block text-center h3 mt-3 mb-4" href="">Festival Celebration</a>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Our Memory & Achievements Since 1954</h1>
                    <p>As we reflect upon the storied history of our school since its inception in 1954, we are reminded of the remarkable journey that has shaped us into who we are today. Our memory is a tapestry woven with threads of dedication, perseverance, and countless achievements that have defined our legacy.</p>
                </div>
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    
                        <img class="img" src="image/first step.PNG">
                        
                    
                    
                        <img class="img" src="image/hard work.PNG">

                    
                    
                        <img class="img" src="image/an achievement.PNG">
                    
                        <img class="img" src="image/golden jubilee.PNG">
